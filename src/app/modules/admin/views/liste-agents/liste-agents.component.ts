...
export class ListeAgentsComponent {
  ...
  constructor(private formBuilder: FormBuilder, private agentService: AgentService,private agence_services:AgencesService) { }
  ...
  deleteAgent(id: number) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        this.agentService.deleteAgent(id).subscribe((res: any) => {
          Swal.fire({
            icon: 'success',
